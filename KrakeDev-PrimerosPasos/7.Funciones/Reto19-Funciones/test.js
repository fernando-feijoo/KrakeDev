...
let imagenPordefecto =
  "https://www.latercera.com/resizer/sDZWiBfVXmWWAXUy2SQ9l2ax12w=/arc-anglerfish-arc2-prod-copesa/public/AWZCXRQ2GNBCNEEMYD6CBRQYX4.jpg";
let testCorrecto =
  "https://media.tenor.com/lHaSX49JtGwAAAAC/ta-bien-esta-bien.gif";
let testIncorrecto =
  "https://media.tenor.com/FS3V9uS5taUAAAAC/what-minion-what.gif";
let testCompletado =
  "https://media.tenor.com/30Q2AgaXvBgAAAAC/minions-animo.gif";
...
testHackearNasaEnPelicula = function () {
  ...
  if (
    JSON.stringify(resultadosCapturados) === JSON.stringify(resultadosEsperados)
  ) {
    setImagen(testCorrecto);
    testNumber = 4;
  } else {
...
testCalcularEdad = function () {
  ...
  setTextoComponente(21, "respuestaEsperada");
...
testRepasarMas = function () {
  ...
  setTextoComponente(
    "En este punto debemos estar super claros en crear funciones",
    "respuestaEsperada"
  );
...
testLlamarAtencion = function () {
  ...
  resultadoLlamarAtencion = llamarAtencion(
    "Programador KrakeDev",
    "no te olvides de cerrar los tags"
  );

  setTextoComponente(
    "Programador KrakeDev no te olvides de cerrar los tags !!",
    "respuestaEsperada"
  );
  setTextoComponente(resultadoLlamarAtencion, "respuestaRecibida");

  if (
    resultadoLlamarAtencion ==
    "Programador KrakeDev no te olvides de cerrar los tags !!"
  ) {
    setImagen(testCorrecto);
    testNumber = 9;
